...
function HomePage() {
  ...
  const slogans = [
    ...
    "Quality Education for Every Student, PUC I & II Resources",
  ...
  return (
    <div>
        ...
        <div className="resource-box">
          <div className="resource-content">
            ...
            <div className="button-wrapper">
                <Link to="/class9">
                  <button className="btn btn-primary">Class 9</button>
                </Link>
              </div>
              <div className="button-wrapper">
                <Link to="/class10">
                  <button className="btn btn-primary">Class 10</button>
                </Link>
              </div>
              <div className="button-wrapper">
                <Link to="/class11">
                  <button className="btn btn-primary">Class 11</button>
                </Link>
              </div>
              <div className="button-wrapper">
                <Link to="/class12">
                  <button className="btn btn-primary">Class 12</button>
                </Link>
              </div>
      ...
      <div className="quality-section-xyz">
        <h2 className="heading-section">Quality Education for All</h2>
    ...
    <div className="quality-section-xyz">
      ...
      <h1 className="main-title">Competitive Exams That You can Prepare For</h1>

      <div className="category-container">
        <h2>National Level Engineering Entrance Exams</h2>
          ...
          <table className="data-table">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>BITSAT</td>
                <td><a href="http://www.bitsadmission.com" target="_blank">www.bitsadmission.com</a></td>
              </tr>
              <tr>
                <td>2</td>
                <td>COMED-K</td>
                <td><a href="https://www.comedk.org/" target="_blank">www.comedk.org</a></td>
              </tr>
              <tr>
                <td>3</td>
                <td>IPU-CET (B. Tech)</td>
                <td><a href="http://www.ipu.ac.in" target="_blank">www.ipu.ac.in</a></td>
              </tr>
              <tr>
                <td>4</td>
                <td>Manipal (B. Tech)</td>
                <td><a href="https://manipal.edu/mu/academics.html" target="_blank">manipal.edu/mu/academics.html</a></td>
              </tr>
              <tr>
                <td>5</td>
                <td>VITEEE</td>
                <td><a href="http://www.vit.ac.in" target="_blank">www.vit.ac.in</a></td>
              </tr>
              <tr>
                <td>6</td>
                <td>AMU (B. Tech)</td>
                <td><a href="http://www.amucontrollerexams.com/" target="_blank">www.amucontrollerexams.com</a></td>
              </tr>
              <tr>
                <td>7</td>
                <td>NDA Entrance with PCM (MPC)</td>
                <td><a href="https://www.nda.nic.in/eligibility%20criteria.html" target="_blank">www.nda.nic.in/eligibility%20criteria.html</a></td>
              </tr>
              <tr>
                <td>8</td>
                <td>All India Engineering Entrance Exam with PCM (MPC)</td>
                <td><a href="http://www.jeemain.nic.in" target="_blank">www.jeemain.nic.in</a></td>
              </tr>
              <tr>
                <td>9</td>
                <td>State Level Engineering Entrance Exams</td>
                <td>
                  Andhra Pradesh - <a href="https://apeamcet.nic.in/Default.aspx" target="_blank">https://apeamcet.nic.in/Default.aspx</a><br />
                  Karnataka - <a href="https://cetonline.karnataka.gov.in/kea/" target="_blank">https://cetonline.karnataka.gov.in/kea/</a><br />
                  Kerala - <a href="http://www.cee-kerala.org/" target="_blank">http://www.cee-kerala.org/</a><br />
                  Maharashtra - <a href="http://www.dtemaharashtra.gov.in/" target="_blank">http://www.dtemaharashtra.gov.in/</a><br />
                  West Bengal - <a href="http://www.wbjeeb.in/" target="_blank">http://www.wbjeeb.in/</a><br />
                  Chattisgarh - PET - Chattisgarh - PET<br />
                  Gujarat - CET (B.Tech) - <a href="http://dte.gswan.gov.in/edte/" target="_blank">http://dte.gswan.gov.in/edte/</a><br />
                  Jammu and Kashmir - CET (B.Tech) - <a href="https://jkbopee.gov.in/" target="_blank">https://jkbopee.gov.in/</a><br />
                  Odisha - JEE (B.Tech) - <a href="http://ojee.nic.in/publicinfo/Public/View.aspx?page=71" target="_blank">http://ojee.nic.in/publicinfo/Public/View.aspx?page=71</a><br />
                  Uttar Pradesh - JEE - <a href="http://www.jeecup.org/" target="_blank">http://www.jeecup.org/</a>
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div className="category-container">
        ...
        <div className="content">
          <p>
            National Eligibility Cum Entrance Test (NEET)<br />
            Purpose: Admission to MBBS / BDS<br />
            Eligibility: Class 12 (PCB)<br />
            Application mode: Online<br />
            Source: <a href="https://www.nta.ac.in/" target="_blank">https://www.nta.ac.in/</a>
          </p>
        </div>
      </div>

      <div className="category-container">
        <h2>Marine, Navy, Defence</h2>
        <div className="content">
          <p>
            Indian Maritime University Common Entrance Test<br />
            Purpose: Admission in Diploma in Nautical Science (DNS) leading to BSc. (Nautical Science)<br />
            Eligibility: Class 12 (PCM)<br />
            Application mode: Online<br />
            Source: <a href="http://www.imu.edu.in/index.php" target="_blank">www.imu.edu.in/index.php</a>
          </p>
          <p>
            Indian Navy B.Tech Entry Scheme<br />
            Purpose: Admission in Indian Navy B.Tech course<br />
            Eligibility: Class 12 passed<br />
            Application mode: Online<br />
            Source: <a href="https://www.joinindiannavy.gov.in/" target="_blank">https://www.joinindiannavy.gov.in/</a>
          </p>
          <p>
            Indian Navy Sailors Recruitment<br />
            Purpose: Admission in 24 weeks Basic training at INS Chilka followed by Professional training<br />
            Eligibility: Class 12 (Maths and Physics/Chem./Bio/Computer Sc.)<br />
            Application mode: Online, By Post<br />
            Source: <a href="https://www.joinindiannavy.gov.in/" target="_blank">https://www.joinindiannavy.gov.in/</a>
          </p>
        </div>
      </div>
      ...
      <div className="category-container">
        ...
        <div className="content">
          <p>
            Indian Army Technical Entry Scheme (TES)<br />
            Purpose: Technical Entry to Army<br />
            Eligibility: Class 12 PCM<br />
            Apply: Online<br />
            Source: <a href="http://www.joinindianarmy.nic.in/" target="_blank">www.joinindianarmy.nic.in/</a>
          </p>
          <p>
            National Defence Academy and Naval Academy Examination (I)<br />
            Purpose: Admission to Army and Air Force wings of NDA and 4 years B. Tech course for the Indian Naval Academy Course (INAC)<br />
            Eligibility: Class 12, 12 Passed<br />
            Application mode: Online<br />
            Source: <a href="http://www.upsc.gov.in/" target="_blank">www.upsc.gov.in/</a>
          </p>
        </div>
      </div>
    </div>
